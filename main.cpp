...
#define Map_Path TEXTURES_DIR "\\map1.png"
#define Maptxt_Path TEXTURES_DIR "\\map.txt"
...
void LoadResources()
{
	...
	textures->Add(202, TEXTURE_PATH_MARIO);
	...
	LPTEXTURE texMario = textures->Get(202);
	...
	mario = new CMario(MARIO_START_X,395, MARIO_START_VX);
	...
	brick1 = new CBrick1(175.0f, 350.0f);
}
